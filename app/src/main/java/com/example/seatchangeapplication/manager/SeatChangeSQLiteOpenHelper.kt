...
class SeatChangeSQLiteOpenHelper(
    ...
    private val DB_FILE_NAME = "seat_change.db"
    private var dbPath: File
    private var databaseExist = true

    init {
        dbPath = context.getDatabasePath(DB_FILE_NAME)
    }
...
//    }
    ...
    fun copyDatabaseFromAssets(): SQLiteDatabase? {
        var inputStream: InputStream? = null
        try {
            inputStream = context.assets.open(DB_FILE_NAME)
